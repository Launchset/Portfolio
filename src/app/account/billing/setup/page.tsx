...
export default async function BillingSetupPage() {
  ...
  if (
    ...
    redirect("/account?billing=already-active");
  if (!environment.STRIPE_PUBLISHABLE_KEY)
    throw new Error("Stripe Embedded Checkout is not configured.");
      ...
      <section className={styles.workspace}>
        <div className={styles.intro}>
          ...
          <dl className={styles.summary}>
            ...
            <div>
              <dt>Price</dt>
              <dd>{formatMoney(client.monthly_fee_cents, client.currency)}</dd>
            </div>
            <div>
              <dt>Recurring</dt>
              <dd>Monthly</dd>
        ...
        <section
          ...
          aria-label="Secure Stripe payment setup"
        >
          <LaunchsetCustomCheckout
